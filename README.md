<!-- TERMINAL HEADER -->
<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&pause=1000&color=00F0FF&center=true&vCenter=true&width=600&lines=System.init(%22Muhammad+Taimoor+Malik%22);;Full-Stack+Software+Engineer;;MERN+%7C+C%2B%2B+%7C+Systems+Architecture;" alt="Typing SVG" />
</div>
...
<table width="100%">
  <tr>
    <td width="60%" valign="top">
      ...
      <ul>
        <li><b>Core Stack:</b> JavaScript / TypeScript, C++, Python</li>
        <li><b>Web Frameworks:</b> React, Next.js, FastAPI, Node.js / Express</li>
        <li><b>Data Layers:</b> MongoDB, Supabase, PostgreSQL</li>
